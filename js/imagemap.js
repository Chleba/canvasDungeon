...
JSDungeon.ImageMap.prototype._animateSprites = function(img, x, y) {
	...
	this.canvasMap.drawImage(img, sx, sy, this.spriteOpt.step, height, x, y, this.spriteOpt.step, height);
};
